...
SideEditCtrl.$inject = ['$scope', 'svcWorkspace', 'svcSharedProperties', 'svcLayer', '$window', 'svcSecurity', '$log'];

function SideEditCtrl($scope, svcWorkspace, svcSharedProperties, svcLayer, $window, svcSecurity, $log){
    var vm = this;
